...
var MAC={
	...
	'History': {
		...
		'Clear': function(){
			...
			$('#history_box').html('<dt class="hisbtn"><a target="_self" href="javascript:void(0)" onclick="MAC.History.Hide();">关闭</a></dt><dd class="hide0">记录已清空</dd>');
		},	
		'Show': function(){
			$('#history_box').show();
		},
		...
		'Create': function($id){
			...
			html +='<dt class="hisbtn"><a target="_self" href="javascript:void(0)" onclick="MAC.History.Clear();MAC.History.Hide();">清空</a> | <a target="_self" href="javascript:void(0)" onclick="MAC.History.Hide();">关闭</a></dt>';
